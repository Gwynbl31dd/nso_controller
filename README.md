...
This is a mix between RPC and REST API capabilities implemented in JAVA.
...
Xplorer can be use as a Java API to communicate with NSO.
...
NSOController provides two main functionality to write a on NSO,
...
NSOController provides an easy way of reading the NSO data in 4 steps.
...
Library   com.apaulin.xplorer.NSOController
...
NSOController provides a lot of functions to validate, create, delete, test NSO and the device.
